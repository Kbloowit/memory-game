         ...
         public static void button_click ()
         {
            /*
             ...
             using (XmlWriter writer = XmlWriter.Create("Savegame.xml", writerSettings)) // hiermee wordt het document aangemaakt
             {
                 ...
                 writer.WriteString(importP1.text);
                 writer.WriteString(score1.text);
                 writer.WriteString(x1.text);
                 writer.WriteStartElement("Player 2");
                 writer.WriteString(importP2.text);
                 writer.WriteString(score2.text);
                 writer.WriteString(x2.text);
